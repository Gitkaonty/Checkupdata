...
const PopupAjustRubriqueEbilanEtatFinancierAnalytique = ({ actionState, row, column, setIsRefreshed, value, id_axe, id_sections, canModify, canAdd, canDelete, canView, deviseParDefaut }) => {
